...
function Tarif() {
  ...
  const data = [
    ...
    {
      value2:
        "Стартовый набор стоимостью 22580 (гарантия на оборудование 3 месяца)",
      type: "Стандарт",
    },
    {
    ...
    {
      value3:
        "Стартовый набор стоимостью 57980 (гарантия на оборудование 1 год)",
      type: "Стандарт+",
    },
    {
  ...
  return (
    <Section ref={element}>
      ...
      <div className="pricing__title">
        <p style={turn ? styles : {}}>От нуля к профессии за 10 дней</p>
            ...
            >
              ...
              <div className="pricing__plan__content">
                  ...
                  {data.map(({ value, value2, value3, type }, index2) => {
                    return (
                      <Fragment key={index2}>
                        {name === "Лайт" ? (
                          type === name ? (
                            <li style={turn ? styles : {}}>{value}</li>
                          ) : (
                            <li style={turn ? styles : {}} className="a">
                              {value}
                            </li>
                          )
                        ) : name === "Стандарт" ? (
                          type === name ? (
                            <li style={turn ? styles : {}}>{value2}</li>
                          ) : (
                            <li style={turn ? styles : {}} className="a">
                              {value2}
                            </li>
                          ...
                          name === "Стандарт+" &&
                          (type === name ? (
                            <li style={turn ? styles : {}}>{value3}</li>
                          ) : (
                            <li style={turn ? styles : {}} className="a">
                              {value3}
                            </li>
                ...
                <div className="pricing__plan__content__actions">
                  <span style={turn ? styles : {}}>Купить сейчас</span>
